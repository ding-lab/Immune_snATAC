...
loom=open_loom(paste(wdir,'/Object/iter_',iter,'/T_cell_PancanObj_pyscenic_output.loom',sep=''),mode='r')
...
saveRDS(regulons, "TF_taargets_across10Iterations.20230914.rds")
write.table(stat, 'TF_frequency.10Iter.20230914.tsv',sep='\t',quote=F,row.names=F)
...
write.table(all_st, "Target_frequency_byTF.10Iter.20230914.tsv",sep='\t',row.names=F,quote=F)